...
Maintaining an optimal network flow necessitates a delicate equilibrium between airport capacity and flight demand.
...
In 2022, a low utilisation was observed at Galeão (SBGL), Brasilia (SBBR), and Rome Fiumicino (LIRF) where the spread between capacity and throughput exceeds 15 flights per hour.
...
In Brazil, we observe a high utilisation of the capacity at Sao Paulo (SBSP) and Rio de Janeiro (SBRJ).
...
The major hub in Brazil, SBGR shows a relatively high base-load-index, however rarely observed peak loads back in 2019.
