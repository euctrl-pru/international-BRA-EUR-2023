...
For European operators, there were two primary factors contributing the the lower performance in the past two years. 
...
The Brazilian study airports show a decrease of the predictability trend in line with the lower pressure on the system and airports during the pandemic phase and increased traffic levels post-pandemic.

On the European side, punctuality levels show a sharp decrease post-COVID and are driven by the system-wide disruptions in 2022. 
For most of the European study airports, departure predictability remained constant of improved in 2023 versus 2022. 
This still indicates that there exists constraints regarding the turnaround of aircraft.
However, departure punctuality performance broadly coincides with the pre-pandemic levels. It is noteworthy to recall that also 2019 has seen major restrictions in the European system.
...
On average, a higher share of flights arrives well ahead of schedule in Brazil. This pattern is largely unchanged when comparing 2019 and 2023. 
The ripple effect of the low preparedness level of European airports to address the returning traffic in 2022 is well documented. It also appears that there are prevailing resource constraints for servicing the demand in 2023.
